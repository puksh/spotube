...
final isBlacklistedProvider = Provider.autoDispose
    .family<bool, SpotubeTrackObject>((ref, track) {
                ...
                children: [
                  Expanded(
                    ...
                    child: Stack(
                      children: [
                        Padding(
                          padding: EdgeInsets.only(right: isCached ? 20 : 0),
                          child: AbsorbPointer(
