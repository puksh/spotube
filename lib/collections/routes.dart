    ...
    AutoRoute(
      ...
      children: [
          ...
          guards: [
            AutoRouteGuardCallback((resolver, router) async {
              final authenticated = await ref.read(
                metadataPluginAuthenticatedProvider.future,
              );

              if (!authenticated && !KVStoreService.doneGettingStarted) {
                resolver.redirectUntil(const GettingStartedRoute());
              } else {
                resolver.next(true);
              }
            }),
        ...
        AutoRoute(
          ...
          children: [
            AutoRoute(path: "playlists", page: UserPlaylistsRoute.page),
            AutoRoute(path: "artists", page: UserArtistsRoute.page),
            AutoRoute(path: "albums", page: UserAlbumsRoute.page),
        ...
        AutoRoute(path: "settings/about", page: AboutSpotubeRoute.page),
        AutoRoute(
        ...
        AutoRoute(path: "liked-tracks", page: LikedPlaylistRoute.page),
        AutoRoute(
          path: "playlist/:id",
        ...
        AutoRoute(path: "track/:id", page: TrackRoute.page),
        AutoRoute(path: "connect", page: ConnectRoute.page),
        AutoRoute(path: "connect/control", page: ConnectControlRoute.page),
        AutoRoute(path: "profile", page: ProfileRoute.page),
        AutoRoute(path: "stats", page: StatsRoute.page),
        AutoRoute(path: "stats/minutes", page: StatsMinutesRoute.page),
        AutoRoute(path: "stats/streams", page: StatsStreamsRoute.page),
        AutoRoute(path: "stats/fees", page: StatsStreamFeesRoute.page),
        AutoRoute(path: "stats/artists", page: StatsArtistsRoute.page),
        AutoRoute(path: "stats/albums", page: StatsAlbumsRoute.page),
        AutoRoute(path: "stats/playlists", page: StatsPlaylistsRoute.page),
      ],
    ),
    CustomRoute(
