...
class PlayerControls extends HookConsumerWidget {
  ...
  const PlayerControls({this.palette, this.compact = false, super.key});
  ...
  Widget build(BuildContext context, ref) {
    final shortcuts = useMemoized(
      () => {
        const SingleActivator(LogicalKeyboardKey.arrowRight): SeekIntent(
          ref,
          true,
        ),
        const SingleActivator(LogicalKeyboardKey.arrowLeft): SeekIntent(
          ref,
          false,
        ),
      },
        ...
        child: Container(
          ...
          child: Column(
            children: [
                      ...
                      children: [
                        Tooltip(
                          ...
                          child: SizedBox(
                            ...
                            child: MouseRegion(
                              cursor: isFetchingActiveTrack
                                  ? SystemMouseCursors.forbidden
                                  : MouseCursor.defer,
                              child: AbsorbPointer(
                                absorbing: isFetchingActiveTrack,
                                child: Stack(
                                  alignment: Alignment.center,
                                  children: [
                                    Opacity(
                                      opacity: isFetchingActiveTrack ? 0 : 1,
                                      child: Slider(
                                        ...
                                        onChangeEnd: isFetchingActiveTrack
                                            ? null
                                            : (value) async {
                      ...
                      return Tooltip(
                        ...
                        child: IconButton(
                          ...
                          variance:
                              ...
                              : ButtonVariance.ghost,
                          onPressed: () async {
                            await audioPlayer.setLoopMode(switch (loopMode) {
              ...
              if (compact && isFetchingActiveTrack)
                const Padding(
